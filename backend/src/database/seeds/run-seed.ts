...
// [productKey, type, quantity(unsigned)/delta(signed for adjustment), daysAgo, hour, minute, userIndex, supplierKey|null, reason, reasonCategory]
// Phase 18 (docs/phase-18-plan.md): the trailing `reasonCategory` is only ever set on
// a stock_out row (null on stock-in / adjustment — the DB @Check enforces that). It
// gives the seeded History screen a realistic spread of the FR-025 categories out of
// the box: mostly sales, a few damage / expiry / internal-use / other cases.
const TRANSACTIONS: [
  string,
  TransactionType,
  number,
  ...
  ['p1', TransactionType.STOCK_IN, 40, 55, 9, 5, 1, 'highland', '', null],
  [
    'p1',
  ...
  ['p1', TransactionType.STOCK_IN, 20, 10, 9, 30, 0, 'highland', '', null],

  ['p2', TransactionType.STOCK_IN, 60, 50, 8, 40, 0, 'highland', '', null],
  [
    'p2',
    TransactionType.STOCK_OUT,
    25,
  ...
  [
    ...
    0,
    null,
    'Past best-before date on the shelf',
    StockOutReason.EXPIRED,
  ],

  ['p3', TransactionType.STOCK_IN, 80, 48, 9, 0, 0, 'highland', '', null],
  [
    'p3',
    TransactionType.STOCK_OUT,
    30,
  ...
  ['p4', TransactionType.STOCK_IN, 24, 44, 8, 55, 2, 'cleanpro', '', null],
  [
    'p4',
    TransactionType.STOCK_OUT,
    10,
  ...
  [
    ...
    1,
    null,
    'Bottles cracked in transit to a customer',
  ...
  ['p5', TransactionType.STOCK_IN, 15, 40, 9, 20, 1, 'cleanpro', '', null],
  [
    'p5',
    TransactionType.STOCK_OUT,
    6,
  ...
  ['p6', TransactionType.STOCK_IN, 18, 38, 9, 10, 0, null, '', null],
  [
    'p6',
    TransactionType.STOCK_OUT,
    5,
  ...
  ['p7', TransactionType.STOCK_IN, 100, 52, 8, 45, 0, 'metro', '', null],
  [
    'p7',
    TransactionType.STOCK_OUT,
    40,
  ...
  ['p8', TransactionType.STOCK_IN, 30, 41, 9, 25, 1, 'metro', '', null],
  [
    'p8',
    TransactionType.STOCK_OUT,
    14,
  ...
  ['p9', TransactionType.STOCK_IN, 36, 37, 8, 50, 2, null, '', null],
  [
    'p9',
    TransactionType.STOCK_OUT,
    20,
  ...
  ['p10', TransactionType.STOCK_IN, 25, 35, 9, 35, 0, 'coastal', '', null],
  [
    'p10',
    TransactionType.STOCK_OUT,
    8,
  ...
  ['p11', TransactionType.STOCK_IN, 10, 30, 8, 40, 2, 'coastal', '', null],
  [
    'p11',
    TransactionType.STOCK_OUT,
    6,
  ...
  [
    ...
    1,
    null,
    'Consumed fulfilling a large outbound shipment',
    StockOutReason.INTERNAL_USE,
  ],

  ['p12', TransactionType.STOCK_IN, 20, 33, 9, 15, 1, 'sunrise', '', null],
  [
    'p12',
    TransactionType.STOCK_OUT,
    9,
  ...
  ['p13', TransactionType.STOCK_IN, 40, 70, 9, 0, 0, 'sunrise', '', null],
  [
    'p13',
    TransactionType.STOCK_OUT,
    40,
    ...
    1,
    null,
    'Discontinuing the product line — cleared the remaining stock',
    StockOutReason.OTHER,
  ],

  ['p15', TransactionType.STOCK_IN, 6, 25, 9, 20, 2, 'coastal', '', null],
  [
    'p15',
    TransactionType.STOCK_OUT,
    5,
